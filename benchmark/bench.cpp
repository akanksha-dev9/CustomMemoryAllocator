...
int main(){
    ...
    std::chrono::duration<double, std::micro> malloc_time=end1-start1;
    ...
    std::chrono::duration<double, std::micro> pool_time=end2-start2;

    //results
    std::cout << "Iterations     : " << iterations << "\n";
    std::cout << "Alloc size     : " << sizeAlloc << " bytes each\n\n";
    std::cout << "malloc/free    : " << malloc_time.count() << " microseconds\n";
    std::cout << "Custom Pool    : " << pool_time.count() << " microseconds\n\n";
